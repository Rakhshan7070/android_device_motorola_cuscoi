...
wlan_dump_path_8450="/data/vendor/ss-ram-dumps/bp-dumps"
...
if [ -d $wlan_dump_path_8450 ]
   then echo "Get 8450 dump file"
   for file in $(ls -1r $wlan_dump_path_8450 );
      do cp -r $wlan_dump_path_8450/$file $wlan_log_dest_path/$file
   done
fi
